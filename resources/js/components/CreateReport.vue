...
//
  ...
  export default {
    ...
    methods: {
        ...
        onInstChange () {
//NOTE:: this is not detecting clear All correctly - resume here
            if (this.selected_insts.length == 1 && this.selected_insts[0] === 0) {
                this.limit_inst_ids = [];
                this.inst_group_id = 0;
                this.filter_options.inst = [...this.institutions];
                this.selections_made = false;
            } else if (this.selected_insts.length > 0) {
        ...
        updateAllInsts() {
          ...
          if (this.allConsoInsts) {
            ...
            this.selected_insts.unshift(0);
            this.filter_options.inst = [{'id': 0, 'name':'All Institutions'}];
          } else {
            this.selected_insts = [];
            this.inst_group_id = 0;
            this.filter_options.inst = [...this.institutions];
